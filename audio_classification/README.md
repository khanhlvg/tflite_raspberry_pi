...
Raspberry Pi doesn't have a microphone integrated on its board, so you need 
to plug in a USB microphone to record audio.
...
```
git clone https://github.com/khanhlvg/tflite_raspberry_pi.git --depth 1
```
