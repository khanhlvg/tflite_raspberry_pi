...
def visualize(
  ...
  Args:
    ...
    detections: The list of all "DetectionResults" entities to be visualize.
  Returns:
  ...
  for detection in detection_results.detections:
    ...
    class_name = detection.classes[0].class_name
    probability = round(detection.classes[0].score, 2)
