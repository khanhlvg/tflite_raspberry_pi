...
"""Unit test of image classification using ImageClassifier wrapper."""
...
class ImageClassifierTest(unittest.TestCase):
  ...
  def test_default_option(self):
    ...
    classifier = ic.ImageClassifier(_MODEL_FILE)
  ...
  def test_allow_list(self):
    ...
    classifier = ic.ImageClassifier(_MODEL_FILE, options=option)
    categories = classifier.classify(self.image)
  ...
  def test_score_threshold_option(self):
    ...
    option = ic.ImageClassifierOptions(score_threshold=_SCORE_THRESHOLD)
    classifier = ic.ImageClassifier(_MODEL_FILE, options=option)
    categories = classifier.classify(self.image)
